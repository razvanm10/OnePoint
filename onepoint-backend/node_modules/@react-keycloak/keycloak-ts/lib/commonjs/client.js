...
class KeycloakClient {
  ...
  createLoginUrl(options) {
    ...
    if (this !== null && this !== void 0 && this.pkceMethod && !!pkceChallenge) {
    ...
    return `${baseUrl}?${(0, _url.formatQuerystringParameters)(params)}`;
  }
  /**
  ...
  createLogoutUrl(options) {
    ...
    return `${this.endpoints.logout()}?${(0, _url.formatQuerystringParameters)(params)}`;
  }
  /**
  ...
  createAccountUrl() {
    ...
    return `${realm}/account?${(0, _url.formatQuerystringParameters)(params)}`;
  }
  /**
  ...
  async updateToken() {
    let minValidity = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 5;
